            ...
            {linhas.map((l, i) => (
              <div key={i} style={mobileCardStyle}>
                <div style={mobileCardHeaderStyle}>
                  <span style={mobileCardTitleStyle}>Trabalhador</span>
                  <button onClick={() => remover(i)} style={mobileRemoveStyle}>
                    Apagar
                  </button>
                </div>
                ...
                <div style={mobileTotalStyle}>Total: {total(l)}h</div>
              </div>
            ))}
          </div>
        ) : (
...
const mobileRemoveStyle: React.CSSProperties = {
  background: "#dc2626",
  color: "white",
  border: "none",
  padding: "8px 12px",
...
const mobileTotalStyle: React.CSSProperties = {
  marginTop: 14,
  padding: 14,
  borderRadius: 14,
  background: "#0b1730",
